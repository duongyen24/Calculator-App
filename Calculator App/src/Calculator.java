...
public class Calculator implements ActionListener {
	...
	Calculator() {
		...
		//set bound
		negButton.setBounds(50, 430, 100, 30);
		delButton.setBounds(150, 430, 100, 30);
		clrButton.setBounds(250, 430, 100, 30);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()== delButton) {
			...
			textfield.setText("");
			for( int i =0; i <string.length()-1; i++) { //delete last number
